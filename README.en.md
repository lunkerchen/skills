...
|---|---|
| [seo-geo-suite](skills/seo-geo/seo-geo-suite/SKILL.md) | **SEO × GEO × AEO × Agent-Readiness Flagship Workspace**: Four-track search system, AI content engineering quality layer (five-question brief, four quality gates, evidence and human ownership), client report output contract (pet-hospitality and electronics diagnostic-report structure), Is-Agentic 100-pt audit, Cloudflare L0–L5, full-site reconnaissance, AEO 40-60 character answer extraction, Markdown Twin content negotiation, and 6 CI/CD quality gates |
