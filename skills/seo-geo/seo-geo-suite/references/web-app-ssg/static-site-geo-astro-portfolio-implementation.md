# the usergram SEO + GEO — Astro Portfolio Walkthrough

Session date: 2026-07-21
Project: `your-brand.example.com` — Astro static portfolio for the site owner / the user.
  ...
  '@graph': [
    {
      ...
      name: 'the usergram',
      url: site,
      description: 'the site owner / the user 的商業攝影與獨立開發作品集。',
      inLanguage: 'zh-TW',
    ...
    },
    {
      ...
      '@id': `${site}/#person`,
      name: 'the site owner',
      alternateName: ['the user', '@your-brand'],
      url: site,
...
**public/llms.txt:**
```
# the usergram — the site owner / the user
...
## About
the site owner, known as the user and @your-brand, works across portrait, wedding,
...
- About the site owner / the user: https://your-brand.example.com/about
